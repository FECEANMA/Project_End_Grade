...
import { CircularProgressbar } from 'react-circular-progressbar';  // Importa el CircularProgressbar
import 'react-circular-progressbar/dist/styles.css';  // Estilos predeterminados para el circular progressbar
...
const Monitor = () => {
  ...
  useEffect(() => {
    const fetchEnergyData = async () => {
      try {
        const response = await axios.get('http://localhost:4000/energy/monitor');
