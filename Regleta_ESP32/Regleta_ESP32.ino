...
#define SERVER_URL    "http://<tu_dominio_o_ip>:3000/energy/monitor" // Asegúrate de reemplazar esto con tu URL del backend
...
void loop() {
  ...
  if (power > 0) {
    sendDataToBackend(voltage, current);
  }
...
void sendDataToBackend(float voltage, float current) {
